 ...
 */
const identifyPageByComment = (source) => {
    const page = {
        title: "",
        description: "",
    };
 ...
 * @returns {Result<Page>}
 */
export const identifyComponents = async (page, uiContent, code) => {
