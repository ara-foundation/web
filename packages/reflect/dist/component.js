...
//     )
// }
export const fileContentToComponent = async (memory) => {
    const component = {
        label: "",
        description: "",
        modulePath: "",
    ...
    if (componentId.isFailure) {
        return Result.fail(`modulePathToCategory(modulePath: '${memory.modulePath}'): ${componentId.errorTitle}`, componentId.errorDescription);
    }
    const { fileName, category } = componentId.getValue();
