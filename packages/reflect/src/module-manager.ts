 ...
 */
export type ModuleRecords = {records: Record<ModulePath, Module>, importMetaFilename?: AbsoluteFilePath};
export type ModuleRecord =  {module: Module, importModuleClause: ModulePath, importMetaFilename?: AbsoluteFilePath}
...
export interface ModuleManager extends Extendable {
    memories: ModuleMemory<unknown>[]; // returns module memories that were tracked
